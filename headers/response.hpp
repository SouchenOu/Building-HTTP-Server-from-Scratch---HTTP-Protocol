...
class response
{
    ...
    public:
        ...
        std::string response_header(int size_of_file, bool var, std::string path_access, int status_code, std::map<unsigned int, std::string> map_Codestatus,Location *Locations,  Request     *request);
